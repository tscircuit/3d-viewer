...
export const RotatedPillHoleWithRectPadDemo: Story = {
  args: {
    circuitJson: [
      {
        type: "pcb_board",
        pcb_board_id: "board_rotated_pill_rect",
        thickness: 1.6,
        num_layers: 2,
        center: { x: 0, y: 0 },
        width: 20,
      ...
      },
      {
        ...
        y: 4,
        layers: ["top", "bottom"],
        pcb_plated_hole_id: "ph-rotated-pill-45-rect-30",
      },
      {
        type: "pcb_plated_hole",
        shape: "rotated_pill_hole_with_rect_pad",
        ...
        y: -1,
        layers: ["top", "bottom"],
        pcb_plated_hole_id: "ph-rotated-pill-neg30-rect-60",
      },
    ],
  },
}
