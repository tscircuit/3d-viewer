...
/**
 * Test story demonstrating different soldermask configurations:
 * - Row 1: Fully covered elements
 * - Row 2: Positive margin
 * - Row 3: Negative margin
 * - Row 4: Default behavior
 *
 * Use the Appearance menu to toggle top/bottom soldermask layers to see the effects.
 */

const soldermaskMarginTestCircuit: AnyCircuitElement[] = [
  {
    type: "pcb_board",
...
export const SoldermaskMarginTest = () => (
  <CadViewer circuitJson={soldermaskMarginTestCircuit} />
)

export default {
  title: "Soldermask Margin Test",
  component: SoldermaskMarginTest,
}
