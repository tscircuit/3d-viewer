...
import { drawPcbSilkscreenText } from "circuit-to-canvas"
...
export function createSilkscreenTextureForLayer({
  ...
  // Draw Silkscreen Text using circuit-to-canvas
  ...
  const colorMap = {
    copper: {
      ...
      inner1: silkscreenColor,
      inner2: silkscreenColor,
      inner3: silkscreenColor,
      inner4: silkscreenColor,
      inner5: silkscreenColor,
      inner6: silkscreenColor,
    },
    copperPour: { top: silkscreenColor, bottom: silkscreenColor },
    drill: silkscreenColor,
    silkscreen: { top: silkscreenColor, bottom: silkscreenColor },
    soldermask: { top: silkscreenColor, bottom: silkscreenColor },
    soldermaskOverCopper: { top: silkscreenColor, bottom: silkscreenColor },
    soldermaskWithCopperUnderneath: {
      top: silkscreenColor,
      bottom: silkscreenColor,
    },
    boardOutline: silkscreenColor,
    substrate: silkscreenColor,
    keepout: silkscreenColor,
    fabricationNote: silkscreenColor,
    courtyard: { top: silkscreenColor, bottom: silkscreenColor },
  }
